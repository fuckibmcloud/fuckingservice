		    ...
		    $i = 0;
				foreach ($days as $day){
						if($i == 0){
									...
									echo '<span class="border"> '.$weather->forecast->forecastday[1]->date.' | ';/*'.$weather->forecast->forecastday[1]->day->mintemp_c.' - '.$weather->forecast->forecastday[1]->day->avgtemp_c.' - '.$weather->forecast->forecastday[1]->day->maxtemp_c.'°C | <img src="'.$weather->forecast->forecastday[1]->day->condition->icon.'" alt="" width=30></span>';
										/*
