  ...
  <div class="caption">
		<?php
		    ...
		    $i = 0;
				foreach ($days as $day){
						if($i == 0){
									echo '<span class="border">COMPANY LOGO | '.$day->date.' | Teplota: '.$weather->current->temp_c.'| <img src="'.$day->day->condition->icon.'" alt="" width=30> | Dnes: '.$weather->forecast->forecastday->1->day->mintemp_c.'-'.$weather->forecast->forecastday->1->day->maxtemp_c.' </span><br>';
